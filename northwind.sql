...
SELECT count(*) AS number_rows FROM Region;
SELECT count(*) AS number_of_columns FROM INFORMATION_SCHEMA.columns;
SELECT count(*) AS number_of_columns FROM INFORMATION_SCHEMA.columns
WHERE table_name = 'Region';

SELECT COUNT(*) AS number_rows FROM Supplier;
SELECT count(*) AS number_of_columns FROM INFORMATION_SCHEMA.columns;
SELECT count(*) AS number_of_columns FROM INFORMATION_SCHEMA.columns
WHERE table_name = 'Supplier';

SELECT COUNT(*) AS number_rows FROM product;
SELECT count(*) AS number_of_columns FROM INFORMATION_SCHEMA.columns;
SELECT count(*) AS number_of_columns FROM INFORMATION_SCHEMA.columns
WHERE table_name= 'product';


SELECT COUNT(*) AS number_rows FROM shipper;
SELECT count(*) AS number_of_columns FROM INFORMATION_SCHEMA.columns;
SELECT count(*) AS number_of_columns FROM INFORMATION_SCHEMA.columns
WHERE table_name= 'shipper';

SELECT COUNT(*) AS number_rows FROM orderdetail;
SELECT count(*) AS number_of_columns FROM INFORMATION_SCHEMA.columns;
SELECT count(*) AS number_of_columns FROM INFORMATION_SCHEMA.columns
WHERE table_name= 'orderdetail';

SELECT COUNT(*) AS number_rows FROM customer;
SELECT count(*) AS number_of_columns FROM INFORMATION_SCHEMA.columns;
SELECT count(*) AS number_of_columns FROM INFORMATION_SCHEMA.columns
